...
public class Projectile : MonoBehaviour {
    ...
    {
        if (other.transform.tag == "RedPlane" || other.transform.tag == "GreenPlane" || other.transform.tag == "RainbowPlane" || other.transform.tag == "OrangePlane")
        {
            switch (other.transform.tag)
            {
                ...
                case "OrangePlane":
                    ...
                    break;
                default:
                    Debug.Log("Problem in Projectile with tag: " + other.transform.tag);
                    break;
            }
